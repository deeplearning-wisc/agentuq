...
class SimulationRun(BaseModel):
    ...
    uq_summary: Optional[dict] = Field(
        description=(
            "Trajectory-level uncertainty quantification summary, keyed by role "
            "(e.g. 'assistant'). Each value contains total_tokens, trajectory_nll, "
            "avg_token_nll, mean_topk_entropy, min_chosen_prob."
        ),
        default=None,
    )
